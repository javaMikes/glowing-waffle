...
<body>
		...
		<div class="span4">
				<div class="sidebarMenu boxModel" id="user_setting_nav" style="margin-left:200px;margin-right:1000px">
					<h1 class="colored">个人设置</h1>
					<ul>
						<li class="active" id="basic_setting_btn"><a href="#"><b>&#8594;</b>上传头像</a></li>
					</ul>
				</div>
			</div><!-- /.span4-->
		
		<div class="user_pic" style="margin-left:550px;margin-top:50px">
			<img alt="上传头像" src="seekExperts"/>
		</div>
		<button type="button" class="btn btn-primary"  data-toggle="modal" data-target="#avatar-modal" style="margin-left:600px;">
				修改头像
		</button>
