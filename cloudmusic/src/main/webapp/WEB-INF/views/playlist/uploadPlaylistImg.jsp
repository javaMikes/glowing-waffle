		...
		<div class="row">
			<div class="col-md-3 col-md-offset-2">
				<div class="sidebarMenu boxModel">
					<h1 class="colored">选择歌单封面</h1>
					<a href="showMyMusicPage?userId=${userInfo.id}" class="btn">返回</a>
				</div>
			</div>
			
			<div class="col-md-6">
				<div class="pic">
					<img alt="歌单图片" src="showPlaylistImg?playlistId=${playlistId}"/>
				</div>
				<button type="button" class="btn btn-primary change_btn"  data-toggle="modal" data-target="#avatar-modal">
						修改图片
				</button>
...
//做个下简易的验证  大小 格式 
	...
	function imagesAjax(src) {
		...
		data.append("playlistId",$("#playlistId").val());
		console.log(src);
		$.ajax({  
		    type : 'post',//请求方式为post  
		    datatype : 'json',//服务端返回的数据类型  
		    url : "uploadPlaylistImg",//接收数据的映射接口  
		    data : data,  
		    /**    
